...
const en: Dictionary = {
  ...
  "entity.email_label": "Email label",
  ...
  "exception.email_label_exists": "A label named '{0}' already exists",
...
const az: Dictionary = {
  ...
  "exception.email_label_exists": "'{0}' adlı label artıq mövcuddur",
