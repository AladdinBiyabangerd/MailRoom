...
export const sentEmails: SentEmailRecord[] = [
  {
    ...
    bodyHtml:
      "<p>Dear team,</p><p>We are excited to announce <strong>new RMS analytics dashboards</strong> rolling out this quarter.</p><ul><li>Revenue forecasting</li><li>Channel mix breakdown</li><li>Competitor rate tracking</li></ul><p>Best regards,<br/>MailRoom Team</p>",
    sentBy: "admin@mailroom.local",
    sentByName: "Aytac Admin",
    sentAt: "2026-06-15 14:32",
    status: "delivered",
    to: [
      { email: "nigar@mailroom.local", name: "Nigar Mövsümova", status: "opened", deliveredAt: "2026-06-15 14:32", openedAt: "2026-06-15 14:45" },
    ...
    cc: [
      { email: "support@mailroom.local", name: "Tariel S.", status: "delivered", deliveredAt: "2026-06-15 14:32" },
    ],
  },
  {
    id: "em-1002",
  ...
  {
    id: "em-1003",
    subject: "Welcome to MailRoom — Getting Started Guide",
    bodyHtml:
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Your <strong>Enterprise plan</strong> has been renewed for another year.</p><p>Thank you for continuing with MailRoom.</p>",
    sentBy: "nigar@mailroom.local",
    sentByName: "Nigar Mövsümova",
  ...
  },
  {
    ...
    bodyHtml:
      "<h3>This week on MailRoom</h3><ul><li>12 new hotel sign-ups</li><li>98.7% uptime across all services</li><li>3 integration updates</li></ul>",
    sentBy: "admin@mailroom.local",
    sentByName: "Aytac Admin",
    sentAt: "2026-06-09 07:00",
    status: "delivered",
    to: [
      { email: "nigar@mailroom.local", name: "Nigar Mövsümova", status: "opened", deliveredAt: "2026-06-09 07:01", openedAt: "2026-06-09 09:15" },
      { email: "support@mailroom.local", name: "Tariel S.", status: "delivered", deliveredAt: "2026-06-09 07:01" },
    ...
    bcc: [
      { email: "archive@mailroom.local", name: "Archive", status: "delivered", deliveredAt: "2026-06-09 07:01" },
    ],
  },
  {
    id: "em-1008",
